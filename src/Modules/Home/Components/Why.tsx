  ...
  return (
    ...
    >
      <div className="grid grid-cols-10 gap-6">
        <div className="col-span-10 md:col-span-5 lg:col-span-6 flex flex-col gap-6 px-4 py-6 border border-border shadow-shadow rounded-base bg-white">
          <div>{data[0]["icon"]}</div>
          <h3 className="text-3xl font-display">{data[0]["title"]}</h3>
          <p>{data[0]["description"]}</p>
        </div>
        <div className="col-span-10 md:col-span-5 lg:col-span-4 flex flex-col gap-6 px-4 py-6 border border-border shadow-shadow rounded-base bg-white">
          <div>{data[1]["icon"]}</div>
